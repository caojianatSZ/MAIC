  ...
  return (
    <section className="text-center" aria-labelledby="classroom-title">
      <div className="container">
        ...
        <div className="bg-white border border-slate-200 rounded-2xl p-8 text-left max-w-2xl mx-auto shadow-sm">
          ...
          <div className="flex gap-6 flex-wrap">
            <div className="flex-1 min-w-40 p-4 bg-slate-50 rounded-lg">
